...
import {
  ...
  applications,
} from "./r-lifi-product-data";
import "./r-lifi-product.css";
...
export default function RLiFiProductClient() {
  ...
  return (
    <div className="rdl-product-page min-h-screen bg-white">
            ...
            <div key={video.title} className="space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                <div className="lg:col-span-6">
                  <div className="relative aspect-video w-full rounded-2xl overflow-hidden bg-black border border-slate-200 shadow-md">
                    <iframe
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 p-4 sm:p-8 shadow-sm max-w-5xl mx-auto overflow-hidden">
            <img
              ...
              alt="R-LiFi System Architecture Diagram"
            ...
            <div className="lg:col-span-6">
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden bg-white border border-slate-200 p-4 sm:p-6 shadow-sm">
                <img
                  ...
                  alt="R-LiFi RF-Free Optical Security Benefits"
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900">
              R-LiFi Transceiver Models & Modules
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {lifiVariants.map((variant) => (
              <VariantCard
                key={variant.title}
                variant={variant}
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-slate-50 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
            ...
            <p className="text-slate-600 text-sm sm:text-base lg:text-lg">
              OEM, white-label, and custom optical development options tailored to your wavelength and baud rate needs.
            </p>
          </div>
      ...
      {/* ── CONTACT MODAL WITH ALWAYS R-LIFI PRE-SELECTION ── */}
      <ContactFormModal
        isOpen={isModalOpen}
        onClose={closeModal}
