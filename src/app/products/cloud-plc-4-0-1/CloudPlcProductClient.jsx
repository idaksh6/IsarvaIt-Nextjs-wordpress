...
export default function CloudPlcProductClient() {
  ...
  return (
    <div className="rdl-product-page min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-14 xl:gap-16 lg:items-stretch">
            ...
            <div className="relative w-full min-w-0 flex flex-col h-full">
              <div className="relative w-full h-auto sm:flex-1 overflow-hidden rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-center p-2 sm:p-4 sm:min-h-[340px]">
                <img
                  src="/products/cloud-plc/cloud-plc-4-0.png"
                  alt="Cloud PLC 4.0 Unit"
                  className="w-full h-auto object-contain sm:max-h-full sm:max-w-full sm:w-auto"
                  loading="eager"
                  decoding="async"
                />
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10 lg:mb-14">
            ...
            <p className="text-sm sm:text-base lg:text-xl text-gray-500 font-medium leading-relaxed">
              Discover the intelligent features that make our Cloud PLC the most reliable choice for industrial automation and IoT edge computing.
            </p>
          </div>
      ...
      <section className="py-12 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="rdl-apps-visual mb-8 sm:mb-10 overflow-hidden rounded-2xl sm:rounded-[1.75rem] border border-slate-200 leading-[0]">
            <img
              src="/products/cloud-plc/banner-1.jpg"
              alt="Cloud PLC applications and dashboards"
              width={1400}
              height={545}
      ...
      <section className="pt-12 pb-8 sm:py-12 lg:py-16 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10 lg:mb-14">
            ...
            <p className="text-sm sm:text-base lg:text-xl text-gray-500 font-medium leading-relaxed">
              Real-world deployment architectures — from multi-protocol gateways to field wiring and SCADA networking.
            </p>
          </div>
      ...
      {/* Order Information & OEM Services */}
            ...
            {orderInfo.map((item) => (
              ...
              >
                ...
                <div className="p-5 sm:p-6 lg:p-8 flex-1">
                  <h3 className="mb-2 sm:mb-3 text-lg sm:text-xl font-bold text-gray-900">{item.title}</h3>
      ...
      <section className="pt-6 pb-8 sm:py-12 lg:pt-16 lg:pb-10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10 lg:mb-14">
            ...
            <p className="text-sm sm:text-base lg:text-xl text-gray-500 font-medium leading-relaxed">
              Choose the right Cloud PLC variant for your environment — Ethernet, LoRa, 4G/LTE or Raspberry Pi based architectures.
            </p>
          </div>
      ...
      <section className="py-12 lg:py-16 bg-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="mb-4 sm:mb-6 text-white capitalize">
            Ready to digitize your industrial control & automation?
          </h2>
          <p className="text-sm sm:text-base lg:text-xl text-blue-100 font-medium leading-relaxed mb-8 sm:mb-10 max-w-2xl mx-auto">
            Integrate seamlessly with legacy Modbus networks and modern cloud infrastructures with our reliable Cloud PLC 4.0.
          </p>
