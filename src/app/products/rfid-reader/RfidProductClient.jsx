...
import {
  ...
  orderInfo,
  rfidOrderTable,
  rfidOrderTableFooterNote,
  applications,
} from "./rfid-product-data";
import "./rfid-product.css";
...
export default function RfidProductClient() {
  const [isModalOpen, setIsModalOpen] = useState(false);
  const [successRedirectUrl, setSuccessRedirectUrl] = useState(null);

  const PRODUCT_NAME = "RFID Reader";
  ...
  return (
    <div className="rdl-product-page min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-12 items-center">
            ...
            <div className="relative w-full min-w-0 flex flex-col justify-center h-full lg:col-span-6">
              <div className="relative w-full overflow-hidden rounded-2xl sm:rounded-3xl bg-[#fafafa] border border-slate-200 p-2 sm:p-6 shadow-md flex items-center justify-center">
                <img
                  src={heroContent.image}
                  alt="UHF RFID Reader System Unit Banner"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-12 lg:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900">
              Key Features & Performance <span className="text-blue-600">Advantages</span>
            </h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-12 lg:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 mb-4">
              RFID System Architecture & Network Topology
            </h2>
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 p-4 sm:p-8 shadow-sm max-w-5xl mx-auto overflow-hidden">
            <img
              ...
              alt="RFID System Architecture Network Topology Diagram"
            ...
            <div className="lg:col-span-6">
              <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden bg-slate-50 border border-slate-200 p-4 sm:p-6 shadow-sm">
                <img
                  ...
                  alt="UHF RFID Reader Robotic Arm Conveyor Integration"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-stretch">
            <div className="lg:col-span-6 lg:order-2 flex flex-col justify-center">
              ...
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 mb-4">
                Industrial RFID Tag Compatibility
              </h2>
              <p className="text-slate-600 text-sm sm:text-base mb-6 font-medium">
                {rfidTagsData.description}
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {rfidTagsData.tagsList.map((tag) => (
                  <div
                    key={tag}
                    className="flex items-center gap-2.5 p-3 rounded-xl bg-white border border-slate-200 text-slate-800 text-xs sm:text-sm font-bold shadow-xs"
                  >
            ...
            <div className="lg:col-span-6 lg:order-1 flex flex-col h-full">
              <div className="relative h-full min-h-full rounded-2xl sm:rounded-3xl overflow-hidden bg-white border border-slate-200 p-4 sm:p-6 shadow-sm flex items-center justify-center">
                <img
                  src={rfidTagsData.image}
                  alt="Industrial RFID Tags Assortment Collection"
                  className="w-full h-full object-contain max-h-[480px] mx-auto rounded-xl"
                  loading="lazy"
                />
              </div>
            </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mb-10">
            SDK's & Programming Languages
          </h2>

          <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12 lg:gap-16">
            {sdkLogos.map((sdk) => (
              <div key={sdk.name} className="flex flex-col items-center gap-2 group">
                <div className="h-16 w-32 bg-slate-50 border border-slate-200 rounded-xl p-3 flex items-center justify-center group-hover:border-blue-300 transition-colors shadow-xs">
                  <img
                    src={sdk.logo}
                    alt={`${sdk.name} SDK Integration`}
      ...
      <section className="py-8 sm:py-16 lg:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-12 lg:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900">
              UHF RFID Reader Models & Hardware Types
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {rfidVariants.map((variant) => (
              <VariantCard
                key={variant.title}
                variant={variant}
      ...
      <section className="py-8 sm:py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-12 lg:mb-16">
            ...
            <p className="text-slate-600 text-sm sm:text-base lg:text-lg">
              OEM, white-label, and custom development options tailored to your scan range and enclosure specifications.
            </p>
          </div>
              ...
              <table className="w-full text-center text-xs sm:text-sm border-collapse min-w-[800px]">
                <thead>
                  <tr className="bg-slate-200 text-slate-800 font-bold border-b border-slate-300">
                    ...
                    <th className="p-3 border-r border-slate-300">Reading Range</th>
                    <th className="p-3 border-r border-slate-300">Reader Type</th>
                    <th className="p-3 border-r border-slate-300">Dimensions</th>
                    <th className="p-3 border-r border-slate-300">Supported Interface / Connectivity</th>
                    <th className="p-3">Action</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-300 text-slate-700 font-medium">
                  {rfidOrderTable.map((row) => (
                    <tr key={row.model} className="hover:bg-blue-50/60 transition-colors">
                      ...
                      <td className="p-3 border-r border-slate-300">{row.dimension}</td>
                      <td className="p-3 border-r border-slate-300 text-slate-800 font-medium">{row.interface}</td>
                      <td className="p-3">
                        <button
                          type="button"
                          onClick={openDemoModal}
      ...
      <section className="py-8 sm:py-16 lg:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-12 lg:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900">
              Deploy across warehouse, logistics, and industrial tracking environments
            </h2>
          </div>
      ...
      <section className="py-12 lg:py-16 bg-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h2 className="mb-4 sm:mb-6 text-white font-extrabold text-2xl sm:text-3xl lg:text-4xl">
            Ready to Automate Your Asset & Inventory Tracking?
          </h2>
          <p className="text-sm sm:text-base lg:text-xl text-blue-100 font-medium leading-relaxed mb-8 sm:mb-10 max-w-2xl mx-auto">
            Deploy long-range UHF RFID technology to gain real-time visibility across supply chain and warehouse facilities.
          </p>
      ...
      {/* ── CONTACT MODAL WITH ALWAYS RFID READER PRE-SELECTION ── */}
      <ContactFormModal
        isOpen={isModalOpen}
        onClose={closeModal}
