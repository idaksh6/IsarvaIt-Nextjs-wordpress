        ...
        <section className="py-16 lg:py-32 bg-slate-50 relative overflow-hidden border-y border-slate-100">
          <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12" style={{ gap: 0, border: '1px solid rgba(226,232,240,0.8)', borderRadius: '32px', overflow: 'hidden' }}>
              {/* Box 1: Migration (Tall) */}
              <div className="md:col-span-1 lg:col-span-4 lg:row-span-2 bento-card group p-6 sm:p-8 lg:p-10 flex flex-col justify-between" style={{ borderRadius: 0, border: 'none', borderRight: '1px solid rgba(226,232,240,0.8)', borderBottom: '1px solid rgba(226,232,240,0.8)', minHeight: '420px' }}>
              ...
              {/* Box 2: Theme Development */}
              <div className="md:col-span-1 lg:col-span-4 bento-card group p-6 sm:p-8 flex flex-col justify-between" style={{ borderRadius: 0, border: 'none', borderRight: '1px solid rgba(226,232,240,0.8)', borderBottom: '1px solid rgba(226,232,240,0.8)' }}>
                <div className="relative z-10">
                  <div className="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center mb-5 text-lg group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">🎨</div>
              ...
              {/* Box 3: Plugin Development */}
              <div className="md:col-span-1 lg:col-span-4 bento-card group p-6 sm:p-8 flex flex-col justify-between" style={{ borderRadius: 0, border: 'none', borderBottom: '1px solid rgba(226,232,240,0.8)' }}>
                <div className="relative z-10">
                  <div className="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center mb-5 text-lg group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">⚙️</div>
              ...
              {/* Box 4: Ecommerce Solution */}
              <div className="md:col-span-1 lg:col-span-4 bento-card group p-6 sm:p-8 flex flex-col justify-between" style={{ borderRadius: 0, border: 'none', borderRight: '1px solid rgba(226,232,240,0.8)', borderBottom: '1px solid rgba(226,232,240,0.8)' }}>
                <div className="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center mb-5 text-lg shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">🛒</div>
                <div>
              ...
              {/* Box 5: Speed & Performance (Fills the gap!) */}
              <div className="md:col-span-1 lg:col-span-4 bento-card group p-6 sm:p-8 flex flex-col justify-between" style={{ borderRadius: 0, border: 'none', borderBottom: '1px solid rgba(226,232,240,0.8)' }}>
                <div className="relative z-10">
                  <div className="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center mb-5 text-lg group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">⚡</div>
              ...
              {/* Box 6: Multisite Development (Wide Footer-left) */}
              <div className="md:col-span-2 lg:col-span-8 bento-card group p-6 sm:p-10 flex flex-col sm:flex-row items-start sm:items-center gap-6" style={{ borderRadius: 0, border: 'none', borderRight: '1px solid rgba(226,232,240,0.8)' }}>
                <div className="w-14 h-14 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center text-2xl shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">🏢</div>
                <div>
              ...
              {/* Box 7: Security & Support (Fills the final gap!) */}
              <div className="md:col-span-1 lg:col-span-4 bento-card group p-6 sm:p-8 flex flex-col justify-between" style={{ borderRadius: 0, border: 'none' }}>
                <div className="relative z-10">
                  <div className="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center mb-5 text-lg group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">🔒</div>
