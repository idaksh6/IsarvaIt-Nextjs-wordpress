...
function buildHeader() {
  ...
  <div class="max-w-7xl mx-auto px-6 flex items-center justify-between">
    ...
    <!-- CTA Button -->
    <a class="press-illusion-btn-orange text-white w-fit font-bold px-8 py-3 text-base items-center space-x-2 !hidden min-[1200px]:!inline-flex transition-all duration-300" href="${SITE_URL}/contact">
