    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        <div className="contact-content">
          {/* Header */}
          <div className="mb-12">
            <h2 id="contact-section-heading" className="text-4xl md:text-5xl font-bold text-white mb-4">
          ...
          {/* Contact Information */}
          <div className="grid md:grid-cols-3 gap-8 mb-12" role="list" aria-label="Contact methods">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20" role="listitem">
              ...
              <p className="text-gray-300"><a href="mailto:info@isarvait.com" className="hover:text-white transition-colors">info@isarvait.com</a></p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20" role="listitem">
              ...
              <p className="text-gray-300"><a href="tel:+919880606087" className="hover:text-white transition-colors">+91 9880606087</a></p>
            </div>
