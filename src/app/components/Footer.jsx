          ...
          <div className="flex flex-col items-center lg:items-end gap-6 mt-2 lg:mt-0 w-full lg:w-auto">
            ...
            <div className="flex items-center gap-2.5 lg:ml-auto mx-auto lg:mx-0 w-fit justify-center">
              ...
              <Link
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.youtube.com/@isarvainfotech"
                aria-label="YouTube"
                className="w-9 h-9 rounded-full bg-[#FF0000] flex items-center justify-center text-white hover:opacity-90 hover:scale-105 transition-all duration-300 shadow-sm"
              >
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-10 lg:mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: "Cybersecurity Solutions", href: "/service/cybersecurity-solutions" },
