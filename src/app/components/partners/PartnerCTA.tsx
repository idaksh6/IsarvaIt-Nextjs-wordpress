      ...
      >
        ...
        <div className="relative z-10 w-full flex flex-col items-center">
          <motion.h2
            ...
            initial="initial"
            whileInView="whileInView"
            className="font-display text-[#111827] mb-6 md:mb-8 md:leading-none er text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase"
          >
          ...
          <div className="flex flex-col items-center gap-6 md:gap-10 w-full">
            <button
              onClick={onApply}
              className="press-illusion-btn-orange w-fit sm:w-auto sm:min-w-[280px] h-14 md:h-16 text-[13px] sm:text-base md:text-xl font-display uppercase tracking-wider px-8 md:px-12 flex items-center justify-center gap-2 md:gap-3 mx-auto"
            >
