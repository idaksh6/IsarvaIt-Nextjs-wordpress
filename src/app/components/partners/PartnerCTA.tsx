    ...
    <section className="py-12 lg:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <motion.div
          ...
          className=" rounded-[32px] md:rounded-[64px] border border-emerald-100 bg-white p-6 sm:p-8 md:p-16 lg:p-24 relative overflow-hidden flex flex-col items-center text-center shadow-2xl shadow-emerald-600/5 group"
        >
          ...
          <div className="relative z-10 w-full flex flex-col items-center">
            <motion.h2
              ...
              initial="initial"
              whileInView="whileInView"
              className="font-display text-[#111827] mb-6 md:mb-8 md:leading-none capitalize"
            >
            ...
            <div className="flex flex-col items-center gap-6 md:gap-10 w-full">
              <button
                onClick={onApply}
                className="press-illusion-btn-orange w-fit sm:w-auto sm:min-w-[280px] "
              >
