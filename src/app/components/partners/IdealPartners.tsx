    ...
    <section className="py-24 bg-[#FDF8F2] relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 text-center">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="font-display text-4xl md:text-6xl font-bold mb-16 text-[#111827] uppercase tracking-tight"
        >
        ...
        <div className="flex flex-wrap justify-center gap-8 max-w-6xl mx-auto">
          {partners.map((item, index) => (
            <motion.div
              ...
              className="flex-1 min-w-[300px] p-12 rounded-[48px] bg-white border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500 group relative overflow-hidden"
            >
              ...
              <h3 className="text-3xl font-bold font-display text-[#111827] uppercase leading-tight mb-6 relative z-10">
                {item.title}
              </h3>
              <p className="text-gray-500 font-body text-lg leading-relaxed relative z-10">
                {item.desc}
              </p>
            </motion.div>
          ))}
