    ...
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          >
            Partnership <span className="text-[#ea580c]">Models</span>
          </motion.h2>
              ...
              (model) =>
                activeTab === model.id && (
                  <motion.div
                    ...
                    className="grid grid-cols-1 lg:grid-cols-12 gap-12 bg-[#F8FAFC]/50 border border-gray-100 p-8 md:p-16 rounded-[48px] shadow-sm items-center"
                  >
