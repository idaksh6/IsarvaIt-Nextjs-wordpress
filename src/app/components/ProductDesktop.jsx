    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="ow-header text-center mb-12">
          ...
          <h2 className="text-[#0a0d14] mb-4 er text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">
            Software Built for{" "}
            ...
            <div className="bg-gradient-to-br from-slate-50 via-white to-gray-50 rounded-t-2xl border-b border-gray-100 sticky top-0 z-20">
              <div className="flex items-center justify-between p-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-gray-900 text-lg leading-5 er text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">
                      Products
                    </h2>
  ...
  return (
    <div className="absolute inset-4 bg-white/95 backdrop-blur-sm rounded-xl border border-gray-300 p-6 overflow-auto z-10 shadow-2xl">
      <div className="flex justify-between items-start mb-6">
        <div>
          <h2 className="text-gray-900 text-2xl mb-2 er text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">{product.name}</h2>
          ...
          <div className="px-6 py-4 border-b border-gray-100">
            <div className="flex items-start justify-between">
              <div className="flex-1 pr-4">
                <h2 className="text-xl text-gray-900 mb-2 line-clamp-2 er text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">
                  {product.name}
                </h2>
