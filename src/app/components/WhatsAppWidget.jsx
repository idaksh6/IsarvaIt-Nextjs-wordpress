    ...
    <div className="fixed bottom-6 right-6 z-[9999] pointer-events-auto">
      <div className="relative group">
        ...
        <button
          ...
          className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-slate-800 text-white text-xs flex items-center justify-center border border-slate-700 shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          title="Close"
