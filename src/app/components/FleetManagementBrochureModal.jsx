    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-xl md:max-w-3xl flex flex-col overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-cyan-500 to-blue-600 px-6 py-4 text-white flex-shrink-0 flex items-center justify-between gap-4">
          <h2 className="capitalize text-xl md:text-2xl font-bold tracking-tight">Download Fleet Management Brochure</h2>
          <button
            onClick={handleClose}
          ...
          <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-3 md:space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 border-2 border-gray-100 rounded-xl focus:border-cyan-500 outline-none transition-all bg-gray-50/50 text-sm text-gray-900"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={2}
                className="w-full px-4 py-2.5 border-2 border-gray-100 rounded-xl focus:border-cyan-500 outline-none transition-all bg-gray-50/50 text-sm text-gray-900 resize-none"
