  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-24 left-10 z-50 bg-[#25D366] text-white rounded-full p-4 hover:scale-110 group transition-transform duration-300"
      ...
      >
        ...
        <svg
          ...
          fill="currentColor"
          viewBox="0 0 24 24"
          style={{ animation: "whatsapp-wiggle 2.5s infinite" }}
        >
