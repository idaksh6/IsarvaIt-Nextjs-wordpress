...
export default function ProductDetailPremium({
  ...
  return (
    <div className="bg-white font-sans selection:bg-red-100 selection:text-red-900">
      ...
      <section className="relative pt-32 lg:pt-40 pb-12 lg:pb-16 overflow-hidden bg-gradient-to-b from-[#f0fdf4] via-[#f7fef9] to-white">
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 lg:flex hidden bg-gradient-to-br from-[#22C55E] to-[#16a34a] rounded-xl  items-center justify-center text-2xl shadow-md">
                      👥
                    </div>
                  </div>
      ...
      <section className="py-12 lg:py-16 bg-gradient-to-b from-white via-[#F7FFF9] to-white relative overflow-hidden">
                  ...
                  >
                    <div className="relative rounded-3xl p-8 h-full bg-white border-2 border-gray-100 shadow-lg flex flex-col">
                      <div className="relative text-center md:text-left flex-1 flex flex-col">
                        ...
                        {/* Category Badge */}
                        <div className="absolute -top-11 -right-2 bg-white text-[#22C55E] text-xs font-bold px-3 py-1 rounded-full border-2 border-[#22C55E]/30 shadow-md">
                          {prod.category}
                        </div>
                      </div>
                    </div>
