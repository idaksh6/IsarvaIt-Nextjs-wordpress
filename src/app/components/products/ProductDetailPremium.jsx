            ...
            <div>
              ...
              <div className="mt-8">
                <button
                  ...
                  className="press-illusion-btn-green bg-green-400 text-white font-bold px-6 py-2 text-base items-center space-x-2 inline-flex cursor-pointer"
                >
                  ...
                  >
                    <div className="relative rounded-3xl p-8 h-full bg-white border-2 border-gray-100 shadow-lg">
                      <div className="relative text-center md:text-left">
                        ...
                        {/* Category Badge */}
                        <div className="absolute -top-11 -right-2 bg-[#22C55E]/10 text-[#22C55E] text-xs font-bold px-3 py-1 rounded-full border-2 border-[#22C55E]/30 shadow-md">
                          {prod.category}
                        </div>
                      </div>
                    </div>
