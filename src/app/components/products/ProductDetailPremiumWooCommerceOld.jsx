...
export default function ProductDetailPremiumWooCommerceOld({
  product,
  relatedProducts,
  allProducts,
}) {
  ...
  return (
    <div className="bg-white font-sans selection:bg-purple-100 selection:text-purple-900">
      ...
      <section className="relative pt-32 lg:pt-40 pb-12 lg:pb-16 overflow-hidden bg-gradient-to-b from-[#faf5ff] via-[#fdf7ff] to-white">
      ...
      <section className="py-12 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            >
              <span className="inline-block text-[10px] font-black text-[#A855F7] tracking-[0.28em] capitalize mb-3 bg-[#A855F7]/10 px-4 py-2 rounded-full">
                OUR SERVICES
              </span>
                ...
                >
                  ...
                  >
                    <div className="relative rounded-3xl p-8 h-full bg-white border-2 border-gray-100 shadow-lg flex flex-col items-center text-center">
                      {/* Category Badge */}
                      <div className="mb-4 bg-[#A855F7]/10 text-[#A855F7] text-xs font-bold px-3 py-1 rounded-full border-2 border-[#A855F7]/30 shadow-md whitespace-nowrap">
                        {prod.category}
                      </div>

                      <div className="relative flex flex-col items-center w-full">
                        {/* Icon */}
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#A855F7] to-[#9333ea] flex items-center justify-center mb-6 shadow-lg mx-auto">
                        ...
                        <div className="mb-2 flex min-h-[3.25rem] w-full items-start justify-center">
                          {prod.tagline ? (
                            <p className="text-[#A855F7] font-semibold line-clamp-2 leading-snug">
                              {prod.tagline}
                            </p>
                          ) : null}
                        </div>
                      ...
                      <div className="mt-auto flex w-full flex-col">
                        ...
                        {/* CTA Link at bottom */}
                        <div className="flex items-center justify-center gap-2 text-[#A855F7] font-semibold pt-2 border-t border-gray-50 w-full">
                          Explore Product
  ...
  return (
    <section className="py-12 lg:py-16 overflow-hidden bg-[#F7F7F7]">
      <div className="max-w-7xl mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-10">
          <span className="block text-[10px] font-black text-[#A855F7] tracking-[0.28em] capitalize mb-2.5">
            KEY FEATURES
          </span>
...
function WooCommerceFAQSection() {
  ...
  return (
    <section className="py-12 lg:py-16 bg-gradient-to-b from-white via-purple-50/30 to-white relative overflow-hidden">
              ...
              <div className="bg-white rounded-2xl shadow-md border-2 border-gray-100 overflow-hidden hover:border-[#A855F7]/30 transition-all duration-300">
                ...
                >
                  <div className="flex items-start gap-4 flex-1">
                    <div className={`flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 ${openIndex === index
                    ...
                    <span className={`font-bold text-lg pr-4 transition-colors ${openIndex === index ? "text-[#A855F7]" : "text-gray-900"
                      }`}>
                      {faq.question}
                    </span>
                  </div>
