...
import FleetManagementBrochureModal from "../../components/FleetManagementBrochureModal";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 lg:text-left text-center">
            ...
            <div>
              ...
              <button
                ...
                className="press-illusion-btn-cyan bg-cyan-400 text-white font-bold px-6 py-2 text-base items-center space-x-2 inline-flex cursor-pointer"
              >
