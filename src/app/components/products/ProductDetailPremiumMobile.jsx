...
import MobileCareBrochureModal from "../../components/MobileCareBrochureModal";
...
export default function ProductDetailPremiumMobile({
  ...
  return (
    <div className="bg-white font-sans selection:bg-violet-100 selection:text-violet-900">
      ...
      <section className="relative pt-32 lg:pt-40 pb-12 lg:pb-16 overflow-hidden bg-gradient-to-b from-[#f5f3ff] via-[#faf5ff] to-white">
      ...
      <section className="py-12 lg:py-16 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-10">
            ...
            >
              <span className="inline-block text-[10px] font-black text-[#8B5CF6] tracking-[0.28em] capitalize mb-3 bg-[#8B5CF6]/10 px-4 py-2 rounded-full">
                MORE PRODUCTS
              </span>
                ...
                >
                  ...
                  >
                    <div className="relative rounded-3xl p-8 h-full bg-white border-2 border-gray-100 shadow-lg flex flex-col">
                      ...
                      {/* CTA Link at bottom */}
                      <div className="flex items-center justify-center md:justify-start gap-2 text-[#8B5CF6] font-semibold mt-auto pt-4 border-t border-gray-50">
                        Explore Product
  ...
  return (
    <section className="py-12 lg:py-16 overflow-hidden bg-[#F7F7F7]">
      <div className="container mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-10">
          <span className="block text-[10px] font-black text-[#8B5CF6] tracking-[0.28em] capitalize mb-2.5">
            SOFTWARE FEATURES
          </span>
