...
export default function ProductDetailPremiumTimeAttendance({
  product,
  relatedProducts,
  allProducts,
}) {
  ...
  return (
    <div className="bg-white font-sans selection:bg-purple-100 selection:text-purple-900">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <p className="text-base text-[#444444] mb-8 max-w-3xl mx-auto leading-relaxed">
              Our Time Attendant System makes easy work of the tedious tasks involved with monitoring employee time and attendance. Our simplified time­tracking software helps you control labour costs, minimise compliance risk, and improve workforce productivity.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <button
                onClick={() => setIsModalOpen(true)}
                className="press-illusion-btn bg-purple-400 text-white w-fit font-bold px-6 py-2 text-base items-center space-x-2 flex cursor-pointer"
              >
        ...
        >
          ...
          <div className="dashboard-main-img">
            <div className="relative overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.2)] bg-white">
              <img
                src="/dashboard.webp"
                alt="Time Attendance System Dashboard"
      ...
      {/* 2. Core Time Attendance Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 lg:text-left text-center">
            ...
            <div>
              <h2 className="text-4xl md:text-[50px] font-extrabold text-[#000000] mb-6 leading-tight">
                Revolutionize Time Tracking with{" "}
                <span className="text-[#8B5CF6]">Intelligent Automation</span>
              </h2>

              <p className="text-lg text-[#444444] mb-6 leading-relaxed">
                Effectively manage your company's time attendance data virtually anywhere, dramatically reducing the number of hours required to process employee time & attendance. Our system automatically calculates total worked hours including overtime, sick days and holidays, ensuring accurate payroll processing every time.
              </p>

              <p className="text-lg text-[#444444] mb-6 leading-relaxed">
                Our next generation browser based interface allows employees and administrators to easily access the application through a web­browser, maintaining everyone in your company connected and empowering your workforce to operate at peak efficiency. No complicated software installations or training required.
              </p>

              <p className="text-lg text-[#444444] mb-8 leading-relaxed">
                The Time Attendant System provides a broad range of configurable time tracking features that allow employers to effectively track employee hours. Each feature is offered to assist in conveniently organizing and quantifying an employee's work day. Gain complete visibility with powerful reporting solutions which empower you with informed real time decision making capabilities so you can easily convert data into actionable, valuable information.
              </p>

              <button
                onClick={() => setIsModalOpen(true)}
                className="press-illusion-btn bg-purple-400 text-white font-bold px-6 py-2 text-base items-center space-x-2 inline-flex cursor-pointer"
              >
                <span>Download Brochure</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      {/* 3. Time Attendance Interactive Feature Section */}
      <div id="time-attendance-features-section">
        <TimeAttendanceFeatureSection />
      </div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div
            ...
            className="relative bg-gradient-to-br from-purple-400 to-fuchsia-500 rounded-[32px] overflow-hidden shadow-[0_20px_70px_rgba(139,92,246,0.2)]"
          >
            {/* Decorative Elements */}
            ...
            <div className="relative z-10 px-8 md:px-16 py-16 md:py-20 text-center">
              ...
              >
                ...
                <p className="text-white/90 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
                  Join businesses using our Time Attendance System to control labour costs, ensure compliance, and improve workforce productivity.
...
/* ─────────────────────────────────────────────────────────────
   TIME ATTENDANCE FEATURE DATA
───────────────────────────────────────────────────────────── */
const timeAttendanceFeatures = [
  {
    id: "time-tracking",
    label: "Simplify Your Time Tracking",
    icon: "⏱️",
    color: "#8B5CF6",
    desc: "Effectively manage your company's time attendance data virtually anywhere, dramatically reducing the number of hours required to process employee time & attendance and automatically calculating total worked hours including overtime, sick days and holidays.",
    placeholder: "TT",
    image: "/dashboard.webp",
  },
  {
    id: "browser-interface",
    label: "Browser Based Interface",
    icon: "🌐",
    color: "#7C3AED",
    desc: "Our next generation browser based interface allows employees and administrators to easily access the application through a web­browser, maintaining everyone in your company connected and empowering your workforce to operate at peak efficiency.",
    placeholder: "BI",
    image: "/dashboard.webp",
  },
  {
    id: "features",
    label: "Packed Full Of Features",
    icon: "⚡",
    color: "#A78BFA",
    desc: "The Time Attendant System system provides a broad range of configurable time tracking features that allow employers to effectively track employee hours. Each feature is offered to assist in conveniently organizing and quantifying an employee's work day.",
    placeholder: "FF",
    image: "/dashboard.webp",
  },
  {
    id: "reporting",
    label: "Powerful Reporting And Analytics",
    icon: "📊",
    color: "#C4B5FD",
    desc: "Gain complete visibility with Easy Clocking reporting solutions which empower you with informed real time decision making capabilities so you can easily convert data into actionable, valuable information.",
    placeholder: "RA",
    image: "/dashboard.webp",
  },
];
...
/* ─────────────────────────────────────────────────────────
   TIME ATTENDANCE FEATURE ORBIT SECTION
──────────────────────────────────────────────────────────── */
function TimeAttendanceFeatureSection() {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-[clamp(28px,4vw,44px)] font-extrabold text-[#0a0a0a] leading-tight mb-3.5">
            Key Features Of <span className="text-[#8B5CF6]">Time Attendance</span> System
          </h2>
          <p className="text-[#6b7280] max-w-[520px] mx-auto text-[15px] leading-relaxed">
            Advanced time tracking features designed to streamline attendance management, reduce costs, and improve workforce productivity.
          </p>
        </div>
