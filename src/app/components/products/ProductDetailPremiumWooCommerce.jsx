...
const features = [
  ...
  { id: "product-management", label: "Product Management", icon: "📦", desc: "Effortlessly manage your product catalog with bulk uploads, variations, attributes, and categories. Organize your inventory for optimal customer experience.", image: "/products/woocommerce/feature-product-management-clean.png", highlight: "Smart Catalog Tools" },
  ...
  { id: "coupon-management", label: "Coupon & Discount Management", icon: "🎟️", desc: "Create and manage promotional campaigns with flexible coupon codes, discount rules, and special offers to boost sales and customer loyalty.", image: "/products/woocommerce/feature-coupon-management-clean.png", highlight: "Boost Conversions" },
  { id: "user-management", label: "User Management & Roles", icon: "👥", desc: "Manage customer accounts, user roles, and permissions. Create custom user experiences with role-based access control and customer groups.", image: "/products/woocommerce/feature-user-management-clean.png", highlight: "Role-Based Access" },
  { id: "page-builder", label: "Custom Page Builder", icon: "📄", desc: "Design stunning product pages, landing pages, and promotional content with drag-and-drop page builders and custom templates.", image: "/products/woocommerce/feature-page-builder-clean.png", highlight: "Drag & Drop Design" },
