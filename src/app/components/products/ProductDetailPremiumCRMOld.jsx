...
export default function ProductDetailPremiumCRMOld({
  product,
  relatedProducts,
  allProducts,
}) {
      ...
      <section className="py-12 lg:py-16 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-10">
            ...
            >
              <span className="inline-block text-[10px] font-black text-[#0EA5E9] tracking-[0.28em] capitalize mb-3 bg-[#0EA5E9]/10 px-4 py-2 rounded-full">
                MORE PRODUCTS
              </span>
