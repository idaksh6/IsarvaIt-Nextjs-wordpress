...
export default function ProductDetailPremiumDealer({
  ...
  return (
    <div className="bg-white font-sans selection:bg-fuchsia-100 selection:text-fuchsia-900">
      ...
      <section className="relative pt-40 lg:pb-32 pb-10 overflow-hidden bg-gradient-to-b from-[#fdf4ff] via-[#fce7f3] to-white">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <button
                ...
                className="press-illusion-btn-fuchsia bg-fuchsia-400 text-white w-fit font-bold px-6 py-2 text-base items-center space-x-2 flex cursor-pointer"
              >
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 lg:text-left text-center">
            ...
            <div>
              ...
              <button
                onClick={() => setIsModalOpen(true)}
                className="press-illusion-btn bg-fuchsia-400 text-white font-bold px-6 py-2 text-base items-center space-x-2 inline-flex cursor-pointer"
              >
                <span>Download Brochure</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="relative z-10 px-8 md:px-16 py-16 md:py-20 text-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <button
                    onClick={() => setIsModalOpen(true)}
                    className="group relative bg-white text-fuchsia-600 px-8 py-4 rounded-full font-bold text-base shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 flex items-center gap-3"
                  >
                    <span>Download Brochure</span>
                    <svg
                  ...
                  <button
                    onClick={() => setIsModalOpen(true)}
                    className="group relative bg-transparent border-2 border-white text-white px-8 py-4 rounded-full font-bold text-base hover:bg-white hover:text-fuchsia-600 transition-all duration-300 hover:scale-105 flex items-center gap-3"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
                  ...
                  >
                    <div className="relative rounded-3xl p-8 h-full bg-white border-2 border-gray-100 shadow-lg">
                      <div className="relative text-center md:text-left">
                        {/* Icon */}
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#D946EF] to-[#C026D3] flex items-center justify-center mb-6 shadow-lg mx-auto md:mx-0">
                        ...
                        {/* Tagline */}
                        {prod.tagline && (
                          <p className="text-[#D946EF] font-semibold mb-3">
                            {prod.tagline}
                          </p>
                        )}
                        ...
                        {/* CTA Link */}
                        <div className="flex items-center justify-center md:justify-start gap-2 text-[#D946EF] font-semibold">
                          Explore Product
                        ...
                        {/* Category Badge */}
                        <div className="absolute -top-11 -right-2 bg-[#D946EF]/10 text-[#D946EF] text-xs font-bold px-3 py-1 rounded-full border-2 border-[#D946EF]/30 shadow-md">
                          {prod.category}
                        </div>
                      </div>
                    </div>
          ...
          >
            <Link
              href="/products"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#D946EF] to-[#C026D3] text-white font-bold text-base rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
