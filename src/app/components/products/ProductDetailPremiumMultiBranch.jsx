...
export default function ProductDetailPremiumMultiBranch({
  product,
  relatedProducts,
  allProducts,
}) {
  ...
  return (
    <div className="bg-white font-sans selection:bg-teal-100 selection:text-teal-900">
      ...
      <section className="relative pt-40 lg:pb-32 pb-10 overflow-hidden bg-gradient-to-b from-[#f0fdfa] via-[#f5fffe] to-white">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_600px_500px_at_center_45%,rgba(20,184,166,0.12)_0%,rgba(20,184,166,0.05)_50%,transparent_100%)] pointer-events-none"></div>

        {/* Additional Teal Glow Accents */}
        <div className="absolute top-20 right-10 w-[400px] h-[400px] bg-[#14B8A6] opacity-[0.04] rounded-full blur-3xl pointer-events-none"></div>
        <div className="absolute bottom-20 left-10 w-[350px] h-[350px] bg-[#0D9488] opacity-[0.03] rounded-full blur-3xl pointer-events-none"></div>
          ...
          >
            <h1 className="text-[32px] md:text-[50px] font-extrabold text-[#000000] leading-tight mb-8">
              ...
              <span className="text-[#000000]">
                with Multi Branch & Multi Warehouse
              </span>
              <span style={{ color: TEAL }}>.</span>
            </h1>
            <p className="text-base text-[#444444] mb-8 max-w-3xl mx-auto leading-relaxed">
              Bill Soft is a comprehensive billing and inventory management solution designed to support businesses with multiple branches and warehouses. It offers robust features to streamline operations, manage stock efficiently, and ensure accurate financial tracking. Additionally, it includes mobile app support for both Android and iOS providing flexibility and accessibility for users on the go.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <button
                onClick={() => setIsModalOpen(true)}
                className="press-illusion-btn-teal bg-teal-400 text-white w-fit font-bold px-6 py-2 text-base items-center space-x-2 flex cursor-pointer"
              >
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 lg:text-left text-center">
            ...
            <div className="relative lg:sticky lg:top-28 lg:self-start">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-6 -left-6 w-32 h-32 bg-[#14B8A6] opacity-10 rounded-full blur-3xl"></div>
              <div className="absolute -bottom-6 -right-6 w-40 h-40 bg-[#14B8A6] opacity-10 rounded-full blur-3xl"></div>
            </div>

            {/* Right Side - Content */}
            <div>
              <h2 className="text-4xl md:text-[50px] font-extrabold text-[#000000] mb-6 leading-tight">
                Powerful Multi-Branch & Warehouse{" "}
                <span className="text-[#14B8A6]">Management System</span>
              </h2>

              <p className="text-lg text-[#444444] mb-6 leading-relaxed">
                Bill Soft supports up to 4 branches with unlimited warehouse management capabilities. Keep track of stock levels across all branches and warehouses with comprehensive product stock tracking that provides real-time visibility into your inventory.
              </p>

              <p className="text-lg text-[#444444] mb-6 leading-relaxed">
                Manage customer credit balances, advance payments, vendor credits, and payment entries seamlessly. The system facilitates payment entries for both sales and purchases, including invoice clearance for received and made payments, ensuring your financial records are always accurate.
              </p>

              <p className="text-lg text-[#444444] mb-8 leading-relaxed">
                Handle sales, purchases, sales returns, and purchase returns with integrated warehouse stock management. Automatically calculate GST for all transactions and support both reverse and forward billing systems. With role-based access control, financial year management, and comprehensive reporting across sales, purchases, stock timelines, warehouse stock, payments, profit and loss, and customer ledgers - Bill Soft empowers your team to deliver exceptional results.
              </p>
      ...
      {/* 3. Multi-Branch Interactive Feature Section */}
      <div id="multi-branch-features-section">
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-teal-50 via-transparent to-cyan-50"></div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div
            ...
            className="relative bg-gradient-to-br from-teal-400 to-cyan-500 rounded-[32px] overflow-hidden shadow-[0_20px_70px_rgba(20,184,166,0.2)]"
          >
            {/* Decorative Elements */}
            ...
            <div className="relative z-10 px-8 md:px-16 py-16 md:py-20 text-center">
              ...
              >
                ...
                <p className="text-white/90 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
                  Join successful enterprises using Bill Soft for efficient multi-branch and multi-warehouse operations.
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-14">
            ...
            >
              <span className="inline-block text-[10px] font-black text-[#14B8A6] tracking-[0.28em] uppercase mb-3 bg-[#14B8A6]/10 px-4 py-2 rounded-full">
                MORE PRODUCTS
              </span>
                  ...
                  >
                    <div className="relative rounded-3xl p-8 h-full bg-white border-2 border-gray-100 shadow-lg">
                      <div className="relative text-center md:text-left">
                        {/* Icon */}
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#14B8A6] to-[#0D9488] flex items-center justify-center mb-6 shadow-lg mx-auto md:mx-0">
                        ...
                        {/* CTA Link */}
                        <div className="flex items-center justify-center md:justify-start gap-2 text-[#14B8A6] font-semibold">
                          Explore Product
                        ...
                        {/* Category Badge */}
                        <div className="absolute -top-11 -right-2 bg-[#14B8A6]/10 text-[#14B8A6] text-xs font-bold px-3 py-1 rounded-full border-2 border-[#14B8A6]/30 shadow-md">
                          {prod.category}
                        </div>
                      </div>
                    </div>
          ...
          >
            <Link
              href="/products"
              className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#14B8A6] to-[#0D9488] text-white font-bold text-base rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
            >
...
const multiBranchFeatures = [
  ...
  {
    id: "sales-payment",
    label: "Sales Payment Management",
    icon: "💳",
    color: "#5EEAD4",
  ...
  {
    id: "purchase-payment",
    label: "Purchase Payment Management",
    icon: "💰",
    color: "#0D9488",
  ...
  {
    id: "transaction-mgmt",
    label: "Comprehensive Transaction Management",
    icon: "📊",
    color: "#5EEAD4",
  ...
  {
    id: "site-config",
    label: "Dynamic Site Configuration",
    icon: "⚙️",
    color: "#5EEAD4",
  ...
  return (
    <section className="py-20 overflow-hidden bg-[#F7F7F7]">
      <div className="container mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-14">
          <span className="block text-[10px] font-black text-[#14B8A6] tracking-[0.28em] uppercase mb-2.5">
            SOFTWARE FEATURES
          </span>
          <h2 className="text-[clamp(28px,4vw,44px)] font-extrabold text-[#0a0a0a] leading-tight mb-3.5">
            Key Features Of <span className="text-[#14B8A6]">Bill Soft</span> Multi-Branch Software
          </h2>
          <p className="text-[#6b7280] max-w-[520px] mx-auto text-[15px] leading-relaxed">
            Enterprise-grade features for managing multiple branches and warehouses with comprehensive control and reporting capabilities.
          </p>
        </div>
        ...
        <div className="hidden xl:block">
          <div className="relative h-[605px] mx-auto xl:w-[80%] lg:w-full">
            ...
            <div
              ...
              style={{ borderColor: 'rgba(20, 184, 166, 0.42)' }}
            />
              ...
              {leftFeatures.map((feature) => (
                <button
                  ...
                  className={`relative bg-white border-[1.5px] rounded-full transition-all duration-200 ease-in-out cursor-pointer flex items-center gap-2 py-2 px-4 pr-4.5 text-[13px] font-semibold whitespace-nowrap ${activeId === feature.id
                    ? "bg-gray-900 border-teal-600 text-black shadow-[0_4px_16px_rgba(0,0,0,0.2)]"
                    : "border-teal-300 text-gray-800 hover:border-teal-500 hover:shadow-md"
                    }`}
                >
                  <span className="text-sm leading-none">{feature.icon}</span>
                  {feature.label}
                  {activeId === feature.id && (
                    <span className="absolute -right-[7px] top-1/2 -translate-y-1/2 w-0 h-0 border-t-[7px] border-t-transparent border-b-[7px] border-b-transparent border-l-[7px] border-l-teal-900" />
                  )}
                </button>
              ))}
            </div>
            ...
            <div className="absolute -right-24 top-1/2 -translate-y-1/2 flex flex-col items-start gap-10 z-10 w-[220px]">
              {rightFeatures.map((feature) => (
                ...
                >
                  ...
                  <span className="text-sm leading-none">{feature.icon}</span>
                  {activeId === feature.id && (
                    <span className="absolute -left-[7px] top-1/2 -translate-y-1/2 w-0 h-0 border-t-[7px] border-t-transparent border-b-[7px] border-b-transparent border-r-[7px] border-r-teal-900" />
                  )}
                </button>
              ))}
            </div>
        ...
        <div className="hidden lg:block xl:hidden">
          ...
          <div className="mb-8">
            <div className="flex flex-wrap gap-3 justify-center">
              {multiBranchFeatures.map((feature) => (
                <button
                  key={feature.id}
                  onClick={() => setActiveId(feature.id)}
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg transition-all duration-200 ${isOpen
                        ? "bg-gradient-to-br from-[#14B8A6] to-[#0D9488] shadow-md scale-110"
                        : "bg-gray-100"
                        }`}
                    >
                    ...
                    <span className={`font-semibold text-sm ${isOpen ? "text-[#14B8A6]" : "text-gray-800"}`}>
                      {feature.label}
                    </span>
                  </div>
                  <div
                    className={`w-6 h-6 rounded-md flex items-center justify-center transition-all duration-200 ${isOpen ? "bg-[#14B8A6] rotate-180" : "bg-gray-100"
                      }`}
                  >
                    <svg
