...
export default function ProductDetailPremiumMultiBranch({
  ...
  return (
    <div className="bg-white font-sans selection:bg-teal-100 selection:text-teal-900">
      ...
      <section className="relative pt-32 lg:pt-40 pb-12 lg:pb-16 overflow-hidden bg-gradient-to-b from-[#f0fdfa] via-[#f5fffe] to-white">
      ...
      <section className="py-12 lg:py-16 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-10">
            ...
            >
              <span className="inline-block text-[10px] font-black text-[#14B8A6] tracking-[0.28em] capitalize mb-3 bg-[#14B8A6]/10 px-4 py-2 rounded-full">
                MORE PRODUCTS
              </span>
                ...
                >
                  ...
                  >
                    <div className="relative rounded-3xl p-8 h-full bg-white border-2 border-gray-100 shadow-lg flex flex-col items-center text-center">
                      {/* Category Badge */}
                      <div className="mb-4 bg-[#14B8A6]/10 text-[#14B8A6] text-xs font-bold px-3 py-1 rounded-full border-2 border-[#14B8A6]/30 shadow-md whitespace-nowrap">
                        {prod.category}
                      </div>

                      <div className="relative flex flex-col items-center w-full">
                        {/* Icon */}
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#14B8A6] to-[#0D9488] flex items-center justify-center mb-6 shadow-lg mx-auto">
                        ...
                        <div className="mb-2 flex min-h-[3.25rem] w-full items-start justify-center">
                          {prod.tagline ? (
                            <p className="text-[#14B8A6] font-semibold line-clamp-2 leading-snug">
                              {prod.tagline}
                            </p>
                          ) : null}
                        </div>
                      ...
                      <div className="mt-auto flex w-full flex-col">
                        ...
                        {/* CTA Link at bottom */}
                        <div className="flex items-center justify-center gap-2 text-[#14B8A6] font-semibold pt-2 border-t border-gray-50 w-full">
                          Explore Product
  ...
  return (
    <section className="py-12 lg:py-16 overflow-hidden bg-[#F7F7F7]">
      <div className="max-w-7xl mx-auto px-6">
        {/* Section Header */}
        <div className="text-center mb-10">
          <span className="block text-[10px] font-black text-[#14B8A6] tracking-[0.28em] capitalize mb-2.5">
            SOFTWARE FEATURES
          </span>
