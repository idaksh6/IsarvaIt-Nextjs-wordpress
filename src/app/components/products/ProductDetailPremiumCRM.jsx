        ...
        <div className="w-full max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <Link
                href="/product/crm-software/crm-pricing"
                prefetch={false}
                className="press-illusion-btn bg-[#0EA5E9] text-white w-fit font-bold px-6 py-2 text-base items-center space-x-2 flex cursor-pointer transition-all hover:bg-[#0284C7]"
              >
