    ...
    <div className="bg-white min-h-screen font-sans text-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <h2 className="text-slate-900 mb-8 text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Your Warehouse in <br /><span className="text-teal-600">Your Pocket.</span></h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div>
              ...
              <h2 className="text-slate-900 mb-8 text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Foundation for <br /><span className="text-teal-600">Enterprise Scale.</span></h2>
      ...
      <section id="features" className="py-24 bg-[#FCFDFF] relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-slate-900 mb-4 text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Powerful Features for Modern Warehouses</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="lg:w-1/2">
              ...
              <h2 className="mb-8 text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Smart Status Updates— <br /><span className="text-teal-400">Zero Manual Work.</span></h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-slate-900 mb-8 text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Meticulous Return <br /><span className="text-teal-600">Management.</span></h2>
      ...
      <section id="reports" className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-slate-900 mb-4 text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Powerful Insight Reports</h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-slate-50 rounded-[4rem] p-12 lg:p-20 relative overflow-hidden">
            <div className="text-center mb-16 relative z-10">
               <h2 className="text-slate-900 mb-6 text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Why Our Godown System Stands Out</h2>
      ...
      <section className="py-24 bg-teal-50 relative overflow-hidden">
         <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            <h2 className="text-slate-900 mb-8 text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Revolutionize Your <br />Warehouse Management Today</h2>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-slate-900 mb-4 text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Related Solutions</h2>
          </div>
