  ...
  const modalContent = (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-xl md:max-w-3xl flex flex-col overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-4 text-white flex-shrink-0 flex items-center justify-between gap-4">
          <h2 className="text-xl er text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Download HRMS Brochure</h2>
          <button
            onClick={handleClose}
          ...
          <form onSubmit={handleSubmit} className="p-4 md:p-6 space-y-3 md:space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 border-2 border-gray-100 rounded-xl focus:border-green-500 outline-none transition-all bg-gray-50/50 text-sm"
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={2}
                className="w-full px-4 py-2.5 border-2 border-gray-100 rounded-xl focus:border-green-500 outline-none transition-all bg-gray-50/50 text-sm resize-none"
            ...
            <div className="pt-1">
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-gradient-to-r from-green-400 to-emerald-600 text-white font-black py-3 px-6 rounded-xl hover:from-green-600 hover:to-emerald-700 transition-all shadow-lg shadow-green-100 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
