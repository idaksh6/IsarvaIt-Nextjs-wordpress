          ...
          <Link href={`/blog/${mainPost.slug}`} className="group">
            <div className="relative aspect-[16/9] rounded-3xl overflow-hidden mb-8 shadow-2xl">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                ...
                <h2 className="text-xl text-white max-w-2xl lg:text-left text-center text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">
                  {mainPost.title}
                </h2>
              </div>
            </div>
