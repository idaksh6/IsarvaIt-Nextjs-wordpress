          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              {job.description && (
                ...
                >
                  <h2 className="font-display text-[#1a1f24] mb-6 flex items-center gap-3 er text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">
              ...
              {job.responsibilities && job.responsibilities.length > 0 && (
                <motion.div
                  ...
                  className="bg-white p-8 md:p-10 rounded-3xl border border-emerald-500/10 shadow-sm"
                >
                  <h2 className="font-display text-[#1a1f24] mb-8 flex items-center gap-3 er text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">
                    <div className="w-2 h-8 bg-[#10b981] rounded-full"></div>
                    Key Responsibilities
                  </h2>
      ...
      <section className="py-20 bg-green-700 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="font-display text-white mb-6 er text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">
