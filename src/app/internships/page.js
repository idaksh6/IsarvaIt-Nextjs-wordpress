      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="font-display text-[#1a1f24] mb-6 capitalize">What You Can Expect</h2>
      ...
      <section className="py-24 bg-[#FDF8F2] relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h2 className="font-display text-[#1a1f24] mb-6 capitalize">Who We're Looking For</h2>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="font-display text-[#1a1f24] mb-6 capitalize">Join Us</h2>
            <p className="text-xl text-[#53606b] max-w-4xl mx-auto leading-relaxed font-medium">
      ...
      <section id="apply" className="py-24 bg-gradient-to-b from-[#FDF8F2] to-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-[#1a1f24] mb-6 capitalize">Internship Application Form</h2>
