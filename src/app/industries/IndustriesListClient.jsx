...
export default function IndustriesListClient({ industriesData }) {
  ...
  const scrollToIndustries = () => {
    if (industriesGridRef.current) {
      industriesGridRef.current.scrollIntoView({ 
        behavior: 'smooth', 
        block: 'start' 
      });
    }
  ...
  return (
    <div className="bg-white overflow-hidden">
              ...
              <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    placeholder="Search industries... (e.g., Banking, Healthcare, Education)"
              ...
              {searchQuery && (
                <div className="mt-4 text-sm text-gray-600 font-medium lg:text-left text-center">
                  {filteredIndustries.length === 0 ? (
                    <span className="text-red-600">No industries found matching "{searchQuery}"</span>
                  ) : filteredIndustries.length === industriesData.length ? (
                    <span>Showing all {industriesData.length} industries</span>
                  ) : (
                    <span>Found {filteredIndustries.length} industr{filteredIndustries.length !== 1 ? 'ies' : 'y'} matching "{searchQuery}"</span>
                  )}
                </div>
              )}
            </div>
      ...
      <section ref={industriesGridRef} className="py-16 lg:py-24 bg-white scroll-mt-8">
