          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {industriesData.map((industry, index) => (
              <Link
                ...
                className="group"
              >
                <div className="relative rounded-3xl p-8 h-full transition-all duration-300 hover:scale-[1.02] bg-white border border-gray-100 shadow-lg hover:shadow-2xl overflow-hidden">
                  ...
                  <div className="relative">
                    {/* Icon with Industry Color */}
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${industry.color} opacity-90 flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                      <span className="text-3xl">{industry.icon}</span>
                    </div>

                    {/* Title */}
                    <h3 className={`text-2xl font-bold text-gray-900 mb-4 group-hover:text-${industry.accentColor}-700 transition-colors duration-300`}>
                      {industry.title}
                    </h3>
                    ...
                    {/* CTA Link */}
                    <div className={`flex items-center gap-2 text-${industry.accentColor}-600 font-semibold group-hover:gap-3 transition-all duration-200`}>
                      Explore Solutions
                    ...
                    <div className={`absolute top-4 right-4 bg-gradient-to-br ${industry.color} opacity-10 text-${industry.accentColor}-700 text-xs font-bold px-3 py-1.5 rounded-full border border-${industry.accentColor}-200`}>
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Connect with our industry experts to discover how we can help you achieve your digital transformation goals.
          </p>
