  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-[#FDF8F2] font-sans text-[#1a1f24] flex items-center justify-center py-44 px-6">
      <div className="max-w-4xl w-full">
        ...
        >
          <h1 className="text-[clamp(2.5rem,6vw,4.5rem)] font-display font-bold text-[#1a1f24] mb-6 leading-tight">
            {content.title}
          </h1>
        ...
        >
          ...
          <div className="p-10">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-2xl font-display font-bold text-[#1a1f24]">
                What Happens Next?
              </h2>
            </div>
