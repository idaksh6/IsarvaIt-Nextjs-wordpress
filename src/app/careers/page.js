      ...
      <section className="lg:py-32 py-10 relative bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center lg:mb-24 mb-10">
            ...
            <h2 className="font-display text-[#1a1f24] mb-6 text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Why Choose Isarva Infotech?</h2>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12 px-4">
            <div className="lg:text-left text-center">
              ...
              <h2 className="font-display text-[#1a1f24] text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Find Your Calling</h2>
            </div>
