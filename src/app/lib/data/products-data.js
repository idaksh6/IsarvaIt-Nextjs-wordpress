...
export const productsData = [
  ...
  },
  {
    ...
    title: "ISARVA LMS – Learning Management System",
    category: "Education Technology",
    icon: "🎓",
    tagline: "One place to run your entire college online",
    shortDescription:
      "Enterprise LMS for schools & colleges — courses, assignments, Google Drive submissions, gradebook, announcements, Q&A, and role-based portals.",
    description:
      "ISARVA LMS is a complete Learning Management System built for schools and colleges. Manage courses, assignments, file submissions, grades, announcements, and student questions — all in one easy-to-use website. Supports Student, Teacher, and Admin portals with 8 customizable color themes.",
    features: [
      "Student, Teacher & Admin Portals",
      "Course & Assignment Management",
      "File & Google Drive Submissions",
      "Gradebook & CSV Reports",
      "Announcements & Q&A Board",
      "Calendar & Due Date Tracking",
      "8 Color Themes per User",
    ...
    technologies: ["Laravel 13", "PHP 8.3+", "MySQL", "Tailwind CSS", "Alpine.js", "Vite"],
    benefits: [
      "Single Platform for All College Operations",
      "No File Size Limits via Google Drive",
      "Transparent Grade Tracking",
      "Reduced WhatsApp Dependency",
      "CSV Export for College Records",
    ],
    color: "from-blue-500 to-indigo-600",
    bgGradient: "from-blue-50 via-indigo-50 to-white",
    keywords: [
    ...
    seoTitle: "ISARVA LMS – Learning Management System for Schools & Colleges",
    metaDescription:
      "Enterprise LMS with courses, assignments, Google Drive submissions, gradebook, announcements, Q&A, and role-based portals for students, teachers, and admins.",
  },
  {
