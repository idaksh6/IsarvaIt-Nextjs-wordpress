...
export const productsData = [
  ...
  },
  {
    ...
    shortDescription: "Next-gen AI computer vision and edge video analytics for PPE safety compliance, manufacturing QC, perimeter radar, and retail telemetry.",
    description: "Isarva Nethra transforms existing IP cameras and industrial CCTV feeds into proactive visual intelligence. Sub-second hazard detection, high-speed defect inspection, and privacy-first DPDP compliance on local edge appliances.",
    features: [
      "Real-Time PPE & Workplace Safety Guard",
      "Conveyor Defect & Sub-Millimeter QC Inspection",
      "Perimeter Tripwire & Critical Threat Radar",
      "Commercial Footfall & Spatial Heatmaps",
      "ANPR & Automated Vehicle Logistics",
      "Facial Recognition & Touchless Access",
      "Sub-15ms Edge Inference Pipeline",
      "Universal RTSP / ONVIF Camera Compatibility",
    ],
    technologies: ["TensorRT", "YOLOv10", "PyTorch", "OpenCV", "NVIDIA Jetson", "WebSockets", "MQTT", "Next.js"],
    benefits: [
      "Zero Cloud Bandwidth Overhead (Edge-First)",
      "99.7% Precision AI Detection",
      "Instant Emergency Halts & WhatsApp Alerts",
      "DPDP & GDPR Privacy-Compliant Architecture",
      "Eliminates 90%+ Manual Inspection Fatigue",
    ],
    color: "from-cyan-500 to-blue-600",
    bgGradient: "from-cyan-50 via-blue-50 to-white",
  },
  {
    slug: "isarva-face-attendance",
    ...
    shortDescription: "Ultra-fast contactless facial recognition attendance and access control platform with live anti-spoofing and instant HRMS payroll integration.",
    description: "Isarva Face Attendance delivers touchless, high-precision biometric attendance powered by deep learning computer vision. Record multi-face check-ins under 0.2s with 99.9% accuracy, automated shift tracking, and direct payroll integration.",
    features: [
      "Sub-200ms Multi-Face Recognition",
      "3D Liveness & Anti-Spoofing Detection",
      "Touchless Contactless Check-In & Access Control",
      "Geo-Fencing & Multi-Branch Management",
      "Direct HRMS, ERP & Payroll Auto-Sync",
      "Real-Time Shift, Overtime & Leave Tracking",
      "Offline Edge Operation with Auto-Sync",
      "Universal Hardware & Mobile App Compatibility",
    ],
    technologies: ["AI Vision", "Deep Learning", "TensorRT", "OpenCV", "Edge AI", "Next.js", "React", "Node.js"],
    benefits: [
      "100% Elimination of Buddy Punching",
      "Instant Attendance Logging Under 0.2 Seconds",
      "Hygienic Zero-Contact Recognition",
      "Centralized Multi-Location Real-Time Dashboard",
      "Automated Shift Roster & Payroll Calculation",
    ],
