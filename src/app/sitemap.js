...
export default function sitemap() {
  ...
  const services = servicesData
    .filter((service) => !service.slug?.includes("-staging") && !service.noIndex && service.slug !== "news-and-magazine-portal" && service.slug !== "whatsapp-crm-integration" && service.slug !== "mobile-app-development")
    .map((service) => ({
