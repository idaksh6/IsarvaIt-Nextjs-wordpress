      ...
      <section className="lg:py-24 py-10 bg-white border-y border-[#10b981]/10 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center lg:mb-20 mb-10">
            ...
            <h2 className="font-display text-[#1a1f24] mb-6 er text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter uppercase">Success Stories on Camera</h2>
