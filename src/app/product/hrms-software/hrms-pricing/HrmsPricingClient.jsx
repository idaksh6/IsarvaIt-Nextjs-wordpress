        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="pricing-demo-cta">
            <button
              ...
              className="press-illusion-btn-orange bg-orange-600 text-white px-8 py-4 rounded-full font-bold text-base inline-flex items-center gap-3 transition-all hover:scale-105"
            >
