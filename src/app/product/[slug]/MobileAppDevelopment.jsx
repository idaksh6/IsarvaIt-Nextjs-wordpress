  ...
  return (
    <>
      <style>{`
        ...
        .mad-phone-1{--t:-3deg;animation:madSide 5s ease-in-out infinite;box-shadow:0 40px 80px rgba(15,23,42,.25)}
        .mad-phone-2{animation:madCenter 5s ease-in-out infinite;box-shadow:0 40px 80px rgba(15,23,42,.25)}
        .mad-phone-3{--t:3deg;animation:madSide 5s ease-in-out infinite .5s;box-shadow:0 40px 80px rgba(15,23,42,.25)}
        ...
        @media (max-width: 1023px) {
          ...
          .mad-phone-1 > div, .mad-phone-2 > div, .mad-phone-3 > div {
        ...
        @media (max-width: 768px) {
          ...
          .mad-phone-1, .mad-phone-3 { width: 35% !important; }
          .mad-phone-2 {
            width: 40% !important;
      ...
      <div className="bg-white overflow-x-hidden">
        ...
        <section className="relative overflow-hidden bg-slate-50 py-12 lg:py-16 pt-24 sm:pt-32 lg:pt-40">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 xl:gap-16 items-center">
              ...
              <div className="mad-phones-wrapper relative flex items-end justify-center min-h-[300px] md:min-h-[520px] py-5 gap-0" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                ...
                `}</style>
                <div className="mad-phone-1 relative flex-shrink-0 w-[190px] lg:w-[150px] xl:w-[210px] z-10" style={{ borderRadius: 36, padding: 10, background: 'linear-gradient(145deg,#2d3748,#1a202c)' }}>
                ...
                <div className="mad-phone-2 relative flex-shrink-0 w-[210px] lg:w-[170px] xl:w-[230px] z-30 -mx-9" style={{ borderRadius: 36, padding: 10, background: 'linear-gradient(145deg,#2d3748,#1a202c)' }}>
                ...
                <div className="mad-phone-3 relative flex-shrink-0 w-[190px] lg:w-[150px] xl:w-[210px] z-20" style={{ borderRadius: 36, padding: 10, background: 'linear-gradient(145deg,#2d3748,#1a202c)' }}>
                ...
                <div className="mad-badge-1 absolute z-40 hidden lg:flex items-center gap-2.5 bg-white rounded-2xl shadow-xl px-5 py-3 text-[13px] font-semibold text-slate-900 lg:right-0 xl:-right-6 2xl:-right-20" style={{ top: '10%' }}>
                ...
                <div className="mad-badge-2 absolute z-40 hidden lg:flex items-center gap-2.5 bg-white rounded-2xl shadow-xl px-5 py-3 text-[13px] font-semibold text-slate-900 lg:left-0 xl:-left-6 2xl:-left-20" style={{ bottom: '15%' }}>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {[
                ...
                <div key={p.title} className={`mad-reveal bg-gradient-to-br from-indigo-500/5 to-emerald-500/5 border border-indigo-500/10 rounded-3xl p-8 flex flex-col items-center text-center gap-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ${p.delay}`}>
                  {/* Center aligned icon */}
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl bg-white shadow-sm flex-shrink-0 mx-auto">
                    {p.icon}
                  </div>
                  <div>
            ...
            <div className="mad-reveal relative rounded-[40px] text-center overflow-hidden px-10 py-16" style={{ background: '#e8f6ea' }}>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 max-w-lg mx-auto w-full">
                ...
                <a href="https://wa.me/919902863697" target="_blank" rel="noopener noreferrer"
                  className="press-illusion-btn-green bg-emerald-600 hover:bg-emerald-700 text-white font-bold px-8 py-4 text-base w-full sm:w-auto items-center justify-center flex cursor-pointer rounded-xl shadow-lg"
                >
