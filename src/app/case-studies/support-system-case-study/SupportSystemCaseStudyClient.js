        ...
        <section className="py-16 md:py-20 px-4 md:px-6 bg-[#FDF8F2]">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl p-8 md:p-14 shadow-xl border border-gray-100 relative">
              <div className="absolute -top-4 -left-4 md:-top-6 md:-left-6 text-emerald-200">
        ...
        <section className="py-16 md:py-20 px-4 md:px-6 bg-white border-t border-gray-100">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 md:mb-6">About Isarva Support Application</h2>
