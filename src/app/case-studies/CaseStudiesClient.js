...
const CASE_STUDIES = [
  ...
  {
    id: 2,
    title: "Streamlining 500+ Employees Payroll",
    client: "Global Logistics Corp",
    industry: "Logistics",
    product: "HRMS Software",
    slug: "#",
            ...
            {filteredStudies.map((study) => (
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-1">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 leading-tight group-hover:text-emerald-600 transition-colors">
                    {study.title}
                  </h2>
