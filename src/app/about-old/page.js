      ...
      <section className="bg-white overflow-hidden border-y border-[#10b981]/10">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1 bg-[#FDF8F2] p-6 md:p-16 lg:p-20 section-animate" style={{ animationDelay: '0.2s' }}>
            <h2 className="lg:text-left text-center font-display text-[#16423C] mb-12 max-w-4xl text-3xl lg:text-5xl font-black leading-[1.25] lg:leading-[1.25] tracking-tighter capitalize">
