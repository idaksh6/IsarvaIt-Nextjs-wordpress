...
export default function ServicesListClient({ servicesData }) {
  ...
  const filteredServices = useMemo(() => {
    ...
    const publicServices = servicesData.filter(service => {
      ...
      return !slug.includes("staging") && slug !== "whatsapp-crm-integration" && slug !== "mobile-app-development";
    });
        ...
        <div className="max-w-7xl mx-auto px-6">
          {filteredServices.length === 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <h3 className="mb-3">No services found</h3>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center group">
              ...
              <h3 className="mb-3">Cutting-Edge Tech</h3>
            ...
            <div className="text-center group">
              ...
              <h3 className="mb-3">On-Time Delivery</h3>
